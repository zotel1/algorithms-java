...
Por ejemplo, en el diagrama anterior, el peso máximo es 14. Muchas veces, el rango de pesos en los bordes está en un rango pequeño (es decir, todos los pesos de los bordes se pueden asignar a 0, 1, 2. W donde W es un número pequeño). En ese caso, el algoritmo de Dijkstra se puede modificar mediante el uso de diferentes estructuras de datos y cubos, lo que se denomina implementación de dial del algoritmo de Dijkstra. la complejidad del tiempo es O(E + WV) donde W es el peso máximo en cualquier borde del gráfico, por lo que podemos ver que, si W es pequeño, esta implementación se ejecuta mucho más rápido que el algoritmo tradicional.*/
